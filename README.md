 ...
 * Next session: <span style="background-color:yellow">[July 9<sup>th</sup>](https://bioinformatics.ccr.cancer.gov/btep/classes/generative-ai-its-all-about-embeddings)</span> <span style="color:maroon"> [GenAI - it's all about embeddings](https://bioinformatics.ccr.cancer.gov/btep/classes/generative-ai-its-all-about-embeddings)</span> <span style="color:maroon"><-- note this session is at the main campus, at 11am</span>.
