 ...
 * Latest/Next session: [<span style="background-color:yellow">November 1<sup>st</sup></span>](https://sites.google.com/mathbiol.org/cloud4bio/2023/2023-11-01-nov) - AI in Medicine Book; JSON-LD workflow engines.
 ...
 * Journal club / speakers [upcoming](https://docs.google.com/document/d/1ADVPnpa5jCIvb9VWBvDIewTeBFdoj2-NrTwZEs-BUio/edit#); 1174714549@teams.nih.govnote search of previous session (since Oct 2019) in the top right corner of the wiki.
...
## Join
Just show up at the meeting site and introduce yourself. Remote participation will also be available after that. The space is available weekly, you are welcome whenever you have the time, or a problem. Better both. To engage and contribute to agenda [use the wiki](https://sites.google.com/mathbiol.org/cloud4bio/home).
