 ...
 * Latest/Next session: [<span style="background-color:yellow">December 12<sup>th</sup></span>](https://sites.google.com/mathbiol.org/cloud4bio/2023/2023-12-12-dec) - An explorative analysis intro do Metric Spaces, Assistant API, WebML advancing
