 ...
 * Latest/Next session: [<span style="background-color:yellow">January 31<sup>th</sup></span>](https://sites.google.com/mathbiol.org/cloud4bio/2024/2024-01-31-jan) - Finish pending topics from last 2 weeks: Explainable AI identifies a new class of antibiotics, finishing news from NeurIPS 2023, dearraying conclusion. Assistant API moved to next week.
